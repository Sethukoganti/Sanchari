    ...
    <div className="min-h-screen pb-24 text-zinc-900 dark:text-[#F8FAFC]">
      ...
      <section id="essentials" className="scroll-mt-28 mt-20">
        <div className="container-site section-pad">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-zinc-900 dark:text-warm-white">
            Travel Essentials & Advisories
          </h2>
          <p className="mt-2 max-w-2xl text-xs sm:text-sm text-zinc-600 dark:text-muted-gray">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {travelEssentials.map((item: { title: string; icon: string; body: string }) => {
              ...
              return (
                <article key={item.title} className="card-surface p-6 bg-white/95 dark:bg-navy-surface/60 border-black/10 dark:border-white/10">
                  ...
                  <h3 className="mt-4 font-display text-lg font-bold text-zinc-900 dark:text-warm-white">
                    {item.title}
                  </h3>
                  <p className="mt-2 text-xs leading-relaxed text-zinc-600 dark:text-zinc-300 font-body">
                    {item.body}
                  </p>
                </article>
              );
      ...
      <section id="faq" className="section-pad scroll-mt-28 mt-16">
        <div className="container-site max-w-3xl">
          ...
          <p className="mt-2 text-xs sm:text-sm text-zinc-600 dark:text-muted-gray">
